...
while edad != -1:
    edad = int(
        input(
            "Ingrese la edad de la persona entre 0 y 100 años, para finalizar la lista ingrese -1: "
        )
    )
    while (edad < 0 or edad > 100) and edad != -1:
        edad = int(
            input(
                "Edad incorrecta. Ingrese la edad de la persona 0 y 100 años, para finalizar la lista ingrese -1: "
            )
        )
    if edad >= mayor_edad:
...
print(
    "Hay ",
    total_mayor_edad,
    "personas mayores de edad. La edad promedio de este grupo es: ",
    promedio_mayor_edad,
)
print(
    "Hay ",
    total_menor_edad,
    "personas menores de edad. La edad promedio de este grupo es: ",
    promedio_menor_edad,
)
