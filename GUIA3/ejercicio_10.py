...
estado_civil = int(
    input(
        "Ingresar el estado civil del trabajador (1 si es soltero o 2 si es casado): "
    )
)
...
sueldo_neto = (
    sueldo_bruto - (monto_desc_jubilacion) - (monto_desc_os) - (monto_desc_sindc)
)

print("El sueldo basico es: $", sueldo_basico)
print("El sueldo bruto es: $", sueldo_bruto)
print(
    "Los descuentos son de : $",
    monto_desc_jubilacion,
    " por jubilacion, $",
    monto_desc_os,
    " por obra social y $",
    monto_desc_sindc,
